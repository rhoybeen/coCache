...
public class RequestUtils {
    ...
    public static List<String> getRequestId(double lamda, int pivot) {
        return getRequestId(lamda, pivot, DEFAULT_REQUEST_AMOUNT);
    }

    public static List<String> getRequestId(double lamda, int pivot, int count) {
